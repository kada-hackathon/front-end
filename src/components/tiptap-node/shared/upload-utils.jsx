...
export const FileDocIcon = (props) => (
  <svg
    width="43"
    height="57"
    viewBox="0 0 43 57"
...
export const FileCornerIcon = (props) => (
  <svg
    width="10"
    height="10"
    viewBox="0 0 10 10"
  ...
  return (
    <div className={className}>
      ...
      <div className={`${className}-content`}>
        <div className={`${className}-file-info`}>
...
/**
 * A component that creates a drag-and-drop area for file uploads
 */
export const UploadDragArea = ({
  onFile,
  children,
  className = "",
}) => {
  ...
  return (
    <div
      className={`${className} ${isDragActive ? "drag-active" : ""} ${isDragOver ? "drag-over" : ""}`}
